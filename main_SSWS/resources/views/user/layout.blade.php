          ...
          <div class="main-navbar">
            <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
              <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                ...
                <span class="d-none d-md-inline ml-1">Welcome {{$name}}</span>
                </div>
              </a>
...
{{-- ....................................Notification Starts.................................. --}}
                ...
                <?php
                    $notification=DB::table('student_applications')->where('enrollment',$enroll)->where('notification',0)->get();
                          ...
                          @foreach ($notification as $n)
                            ...
                            <a class="dropdown-item" onclick="getN({{$n->id}})">
                                ...
                                <div class="notification__content">
                                    <span class="notification__category">Application for {{$n->type_of_leave}} ({{$n->submitted_date}})</span>
                                    @if ($n->status=='confirmed')
                                        <b><p class="text-success">{{$n->status}}</p></b>
                                    @else
                                        <b><p class="text-danger">{{$n->status}}</p></b>
                                    @endif
                                </div>
                                </a>
                        @endforeach
...
{{-- ....................................Notification End.................................. --}}
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        <?php
                        $query=DB::table('student_info')->select('image')->where('enrollment',$enroll)->first();
                        echo '
                            <img src="data:image/jpeg;base64,'.base64_encode($query->image).'" class="user-avatar rounded-circle mr-2" height="40" width="50" />
                            ';
