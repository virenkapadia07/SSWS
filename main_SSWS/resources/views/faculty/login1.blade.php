            ...
            <div>
                <div class="card card-small blog-comments" style="border-radius: 5%">
                    <div class="card-header border-bottom" style="background-color: #fff;border-top-right-radius:50%;border-top-left-radius: 20%">
                        <h6 class="m-0">Faculty Login</h6>
                    </div>
                        <div class="card-body d-flex flex-column">
                        <form class="" action="doLogin" method="POST">
                            @csrf
                            <div class="form-group">
                                <input type="text" class="form-control" id="facultyID" name="facultyID" placeholder="Faculty ID" onkeyup="CheckFacultyID()">
                            ...
                            <div style="text-align:right;font-size: .8125rem">
                                <a style="color:#007bff" href=#>Forgot Password?</a>
                            </div>
                            <div class="form-group mb-0">
                                <button type="submit" class="btn btn-accent" id="login" style="width:100%;margin-top:5px;color;background-color:#007bff;color:white" id="login">Login</button>
                            </div>
                            <div style="text-align:center;font-size:.8125rem;padding-top:5%">
                                <a style="color:#007bff" href="register">New Here!! Register Now</a>
                            </div>
